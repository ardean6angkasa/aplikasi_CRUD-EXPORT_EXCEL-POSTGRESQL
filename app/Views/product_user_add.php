    ...
    <br> 
        ...
        <div class="col-md-4">
            ...
            <div class="col-md-8">
                ...
                <span class="<?= isset($validation) && $validation->hasError('nama-barang') ? 'text-danger' : ''; ?>">
        ...
        <div class="row mt-4" style="margin-left: 170px;">
            <div class="col-md-4">
                ...
                <span class="<?= isset($validation) && $validation->hasError('harga-beli') ? 'text-danger' : ''; ?>">
            ...
            <div class="col-md-4">
                ...
                <span class="<?= isset($validation) && $validation->hasError('harga-jual') ? 'text-danger' : ''; ?>">
            ...
            <div class="col-md-4">
                ...
                <span class="<?= isset($validation) && $validation->hasError('stok-barang') ? 'text-danger' : ''; ?>">
        ...
        <label for="image" style="margin-bottom:10px;">Upload Image</label>      
            ...
            <input type="file" id="uploadFile" accept="image/*" multiple style="display: none;" name="image">           

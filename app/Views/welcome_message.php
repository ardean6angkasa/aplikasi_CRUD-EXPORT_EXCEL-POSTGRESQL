    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 bg-light p-5 d-flex flex-column justify-content-center align-items-center">
                <b>
                    <img src="/img/handbag-svgrepo-com.svg" style="width: 20px; height: 20px; vertical-align: middle;"
                        alt="Icon">
                ...
                <form action="<?= base_url('/login') ?>" method="POST">
                    ...
                    <div class="mb-3 input-group border align-items-center rounded">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                                <img src="/img/lock-keyhole-svgrepo-com.png" style="width: 16px; height: 16px;"
                                    alt="Icon-lock">
                            </span>
                        </div>
                        ...
                        <div class="input-group-append">
                            <span class="input-group-text" id="togglePassword">
                                <img src="/img/eye-svgrepo-com copy.png" style="width: 16px; height: 16px;"
                                    alt="Icon-eye">
                            </span>
                        </div>
                    </div>

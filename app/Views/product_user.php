        ...
        <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="mb-3 input-group border align-items-center rounded">
                            <div class="input-group-prepend">
                                <span class="input-group-text">
                                    <img src="/img/search-alt-1-svgrepo-com copy.png" style="width: 16px; height: 16px;"
                                        alt="Icon-search">
                                </span>
                            </div>
                            <input type="text" class="form-control" placeholder="Cari barang" name="keyword"
                                value="<?= session()->get('kata_pencarian') ?>" autocomplete="off" autofocus>
                        </div>
                    </form>
            ...
            <div class="btn-group" style="margin-top: 44px;">
                <?php if (!empty($products)): ?>
                    <a href="<?= base_url('/export-excel') ?>" class="btn ms-2 custom-button-Excl"><img
                            src="/img/MicrosoftExcelLogo.png" style="vertical-align: middle;" alt="Icon-excel">
                        Export Excel
                    </a>
                <?php endif; ?>
                <a href="<?= base_url('/add_product'); ?>" class="btn ms-2 custom-button-AddItem"
            ...
            <table class="table mt-3 table-sm">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;" scope="col">Kategori Produk</th>
                        <th style="text-align: center;" scope="col">Harga Beli (Rp)</th>
                        <th style="text-align: center;" scope="col">Harga Jual (Rp)</th>
                        <th style="text-align: center;" scope="col">Stok Produk</th>
                        <th style="text-align: center;" scope="col">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    <?php $total_data = 1 + (6 * ($currentPage - 1)); ?>
                    <?php
                    foreach ($products as $product):
                        ...
                        <tr>
                            ...
                            <td><img src="<?= base_url('/upload/' . $product['image']) ?>"
                                    alt="<?= $product['nama_produk'] ?>" style="width: 40px; height: 40px;"></td>
                            <td>
                                <?= $product['nama_produk'] ?>
                            </td>
                            <td>
                            ...
                            <td style="text-align: center;">
                                <button type="button" class="btn edit-button" data-toggle="modal"
                                    data-target="#editProductModal<?= $product['id'] ?>">
                                    <img src="<?= base_url('/img/edit.png') ?>" alt="update-data">
                                </button>
                                <button type="button" class="btn delete-button" data-toggle="modal"
                                    data-target="#deleteProductModal<?= $product['id'] ?>">
                                    <img src="<?= base_url('/img/delete.png') ?>" alt="delete-data"
                                        style="margin-left: 10px;">
                                </button>
                            </td>
                        </tr>
                        ...
                        <div class="modal-body">
                            ...
                            <div>
                                ...
                                <input type="text" class="form-control" name="nama-barang"
                                    placeholder="Masukkan nama barang" style="border: 1px solid #ccc !important;"
                            ...
                            <div>
                                ...
                                <input type="text" class="form-control" name="stok-barang"
                                    placeholder="Masukkan stok barang" style="border: 1px solid #ccc !important;"
                            ...
                            <div>
                                ...
                                <div id="dropArea" class="drop-area">
                                    <img id="selectedImage" src="/upload/<?= $product['image']; ?>" alt="gallery"
